...
class Container_21cb0072fd extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_21cb0072fd $container)
			{
	...
	public function createServiceContainer(): Container_21cb0072fd
	{
		return $this;
	}
