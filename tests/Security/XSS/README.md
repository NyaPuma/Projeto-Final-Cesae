...
**Cross-Site Scripting (XSS)** -- An attacker cannot inject malicious script into web pages that runs in other users' browsers.
...
# A specific test
php artisan test tests/Security/XSS --filter=TestName
```
