...
class UserTest extends TestCase
{
    ...
    public function it_has_correct_role_constants()
    {
        ...
        $this->assertNotNull(UserRoleEnum::User->value);
        $this->assertEquals('user', UserRoleEnum::User->value);

        $this->assertNotNull(UserRoleEnum::Technician->value);
        $this->assertEquals('technician', UserRoleEnum::Technician->value);

        $this->assertNotNull(UserRoleEnum::Admin->value);
    ...
    public function it_validates_profile_name()
    {
        ...
        $validProfiles = [UserRoleEnum::User->value, UserRoleEnum::Technician->value, UserRoleEnum::Admin->value];
    ...
    {
        $profile1 = UserProfile::firstOrCreate(['name' => UserRoleEnum::User->value]);
