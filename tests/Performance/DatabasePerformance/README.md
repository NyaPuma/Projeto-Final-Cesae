# Database Performance -- Automated Performance Tests
...
Performance tests for **Database Performance** -- database queries are fast enough. These verify the system's speed and responsiveness.
...
# A specific test
php artisan test tests/Performance/DatabasePerformance --filter=TestName
```
