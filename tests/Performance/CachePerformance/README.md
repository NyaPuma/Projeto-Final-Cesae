# Cache Performance -- Automated Performance Tests
...
Performance tests for **Cache Performance** -- caching speeds up repeated requests correctly. These verify the system's speed and responsiveness.
...
# A specific test
php artisan test tests/Performance/CachePerformance --filter=TestName
```
