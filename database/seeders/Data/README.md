...
| `TicketDataset.php` | A **ticket generator** that produces a coherent set of ~60 synthetic maintenance tickets, following fixed realistic rules — Pareto distribution across equipment, SLA calculated from open/close times, costs consistent with labour, weighted priorities/statuses/sources, and a spread across the last six months. |
