    ...
    <div class="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-sm">
        <form id="editUserForm" class="space-y-6">
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                <button type="submit" class="ui-button ui-button--primary inline-flex items-center justify-center rounded-2xl px-5 py-3 text-sm font-semibold transition hover:opacity-90">Guardar Alterações</button>
