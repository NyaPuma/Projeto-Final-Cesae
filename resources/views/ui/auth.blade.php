                ...
                <div class="grid min-h-[720px] lg:grid-cols-[0.95fr_1.05fr]">
                    <div class="flex flex-col justify-between bg-[var(--surface-2)]/70 p-8 lg:p-10">
                        <div>
                            ...
                            <p class="mt-4 max-w-md text-sm leading-7 text-[var(--text-soft)] sm:text-[15px]">
                                Aceda ao painel de operação com um ambiente profissional, simples e focado na autenticação.
                            </p>
                        </div>

                        <div class="mt-10 space-y-4">
                            <div class="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4">
                                <p class="text-sm font-semibold text-[var(--text)]">Acesso direto</p>
                                <p class="mt-2 text-sm leading-7 text-[var(--text-soft)]">Utilize as suas credenciais para entrar no painel principal.</p>
                            </div>
                            <div class="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4">
                                <p class="text-sm font-semibold text-[var(--text)]">Sessão protegida</p>
                                <p class="mt-2 text-sm leading-7 text-[var(--text-soft)]">A autenticação é processada de forma segura e imediata.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-8 lg:p-10">
                        <div class="w-full max-w-md">
                            <div class="mb-8">
                                <p class="text-sm font-semibold uppercase tracking-[0.24em] text-[var(--text-soft)]">Iniciar sessão</p>
                                <h2 class="mt-3 text-3xl font-black tracking-tight text-[var(--text)]">Bem-vindo de volta</h2>
                                <p class="mt-3 text-sm leading-7 text-[var(--text-soft)]">Introduza o seu email e palavra-passe para continuar.</p>
                            </div>
                            ...
                            <form id="loginForm" class="space-y-5">
                                <div>
                                    <label for="loginEmail" class="mb-2 block text-xs font-bold uppercase tracking-[0.2em] text-[var(--text-soft)]">Email</label>
                                ...
                                <div>
                                    <label for="loginPassword" class="mb-2 block text-xs font-bold uppercase tracking-[0.2em] text-[var(--text-soft)]">Palavra-passe</label>
                                    <div class="relative">
                                        ...
                                        <button type="button" id="togglePassword" class="absolute right-3 top-1/2 -translate-y-1/2 text-sm font-semibold text-primary transition hover:opacity-70">Mostrar</button>
                                    </div>
                                </div>

                                <button type="submit" class="ui-button group inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-primary px-4 py-3.5 text-sm font-bold text-black shadow-lg shadow-primary/20 transition hover:-translate-y-0.5 hover:shadow-xl hover:shadow-primary/30">
                                    Entrar no sistema
    ...
    (function () {
        ...
        function setLoading(loading) {
            ...
            btn.innerHTML = loading
                ? '<span class="inline-flex items-center gap-2"><svg class="h-4 w-4 animate-spin" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3" class="opacity-20"></circle><path fill="currentColor" class="opacity-90" d="M4 12a8 8 0 018-8V0A12 12 0 000 12h4z"></path></svg>A autenticar...</span>'
                : 'Entrar no sistema <svg class="h-4 w-4 transition group-hover:translate-x-1" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>';
        }
