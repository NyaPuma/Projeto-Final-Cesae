    ...
    <form id="loginForm" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" id="togglePassword" class="absolute right-3 top-1/2 -translate-y-1/2 text-sm font-semibold text-primary transition hover:opacity-70">{{ __('common.Mostrar') }}</button>
            </div>
        </div>
