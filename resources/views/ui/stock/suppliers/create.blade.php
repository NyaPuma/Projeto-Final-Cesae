...
@section('page_key', 'stock-suppliers-create')
        ...
        <form id="supplierForm" class="space-y-6" novalidate data-supplier-form-mode="create">
            <div class="grid gap-6 lg:grid-cols-2">
                <div>
                    ...
                    <input id="supplierName" name="name" type="text" required value="{{ old('name') }}"
                ...
                <div>
                    ...
                    <input id="supplierNif" name="nif" type="text" value="{{ old('nif') }}"
                ...
                <div>
                    ...
                    <input id="supplierContact" name="contact" type="text" value="{{ old('contact') }}"
                ...
                <div>
                    ...
                    <input id="supplierEmail" name="email" type="email" value="{{ old('email') }}"
                ...
                <div>
                    ...
                    <input id="supplierLeadTime" name="avg_lead_time_days" type="number" min="0" step="1" value="{{ old('avg_lead_time_days') }}"
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea id="supplierAddress" name="address" rows="3" class="w-full rounded-2xl border border-(--border) bg-(--surface-2) px-4 py-3 text-sm text-(--text) outline-none transition focus:border-primary focus:ring-4 focus:ring-primary/15">{{ old('address') }}</textarea>
                </div>
            </div>
