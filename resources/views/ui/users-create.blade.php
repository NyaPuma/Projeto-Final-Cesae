        ...
        <form id="createUserForm" class="space-y-6">
            <div class="grid gap-6 lg:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="userName" name="name" required class="w-full rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] px-4 py-3 text-sm text-[var(--text)] outline-none focus:border-primary focus:ring-4 focus:ring-primary/15" placeholder="Ex.: João Silva">
                </div>
                <div>
                ...
                <div>
                    <label class="mb-2 block text-xs font-bold uppercase tracking-[0.2em] text-[var(--text-soft)]">Palavra-passe</label>
...
document.getElementById('createUserForm').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        message.textContent = 'Utilizador criado com sucesso! A redirecionar...';
