...
@section('title', __('Preferências do Utilizador'))

@section('content')
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">
            {{ __('Preferências do Utilizador') }}
        </h1>

        <div class="mb-8">
            <h2 class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-4">
                {{ __('Configurações Independentes') }}
            </h2>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">
                {{ __('Ajuste as suas preferências de língua, moeda e formato de data independentemente.') }}
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('preferences.update_all') }}" class="space-y-8">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {{ __('Controla a língua da interface da aplicação.') }}
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {{ __('Formato de valores monetários (ISO 4217).') }}
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {{ __('Formato usado para exibir datas.') }}
                </p>
            </div>
            ...
            <div class="pt-6">
                ...
                >
                    {{ __('Guardar Todas as Preferências') }}
                </button>
            </div>
        </form>
    </div>
