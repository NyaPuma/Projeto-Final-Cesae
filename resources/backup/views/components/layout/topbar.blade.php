...
<header class="sticky top-0 z-40 h-20 border-b border-(--border) bg-(--topbar) backdrop-blur-xl">
    <div class="h-full px-8 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            <button
                ...
                class="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-(--border) bg-(--surface) text-sm shadow-sm transition-all hover:bg-(--surface-2) cursor-pointer"
